...
//                       <p>{invoices.nama}</p>
//                     </div>
//                     <p className="text-sm text-gray-500">{invoices.no_telp}</p>
//                      {/* <p className="text-sm text-gray-500">{invoices.kuantitas}</p> */}
//                   </div>
              ...
              >
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{invoice.no_telp}</p>
                    <p className="text-sm text-gray-500">{invoice.pembayaran}</p>
                  </div>
                  <InvoiceStatus status={invoice.status} />
                </div>
                <div className="flex w-full items-center justify-between pt-4">
